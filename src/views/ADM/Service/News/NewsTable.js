...
import { NTC_DATA, NTC_DEL } from './NewsQuery';
import { toast } from 'react-toastify';
import {param, tableRemoveDispatch, tableSelectDispatch} from "./NewsComponent/NewsUtils"
import { titleStyle } from './NewsComponent/NewsStyle';
 const NewsCloumns = [
  {
    headerName: '서비스',
    field: 'SVC_NM_LST',
...
const NewsTable = () => {
  ...
  const[refetch ] = useLazyQuery(NTC_DATA, {  // 데이터 삭제시 그리드 테이블 리프레쉬
